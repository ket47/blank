<template>
  <ion-page>
    <ion-header :class="[pageClass, 'ion-no-border']" >
      <ion-toolbar :color="headerColor ?? 'white'">
        ...
        <ion-icon  v-if="pageLogo" class="toolbar_svg_logo" :style="`color: ${(headerColor) ? 'white' : 'var(--ion-color-primary'})`"  :icon="pageLogo"/>
        <div slot="end">
