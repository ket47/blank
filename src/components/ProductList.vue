    ...
    <div class="product_list_widget_grid">
        ...
        >                
            <div style="position:relative;left:-50%">
                <cart-add-buttons buttonLayout="vertical" :productId="productItem.product_id" :productItem="productItem" :productQtyStep="productItem.product_quantity_min||1"></cart-add-buttons>
            </div>
            <div style="" class="product_list_item_img">
                <router-link class="link" :to="'product-' + productItem.product_id">
                    <ion-img :src="$store.state.hostname +'/image/get.php/' +productItem.image_hash +'.150.150.jpg'"/>
                </router-link>
            </div>
